...
export default function FooterCopyRights({ payment, className = "" }: Props) {
  const t = useTranslations("Footer");
  return (
    <div className="copyrights">
      <div className="container-fluid">
        <div className="d-md-flex justify-content-between">
          <ul className="list-unstyled d-flex flex-wrap gap-2rem p-0">
            ...
            <li>
              <Link href="/my-account">
                {t("returns-and-shipping")}
              </Link>
            </li>
          </ul>
          <ul className="list-unstyled d-flex flex-wrap gap-1rem social-list p-0">
            <li>
              <Link href="https://www.tiktok.com/@a2zmegastore.kw">
                <svg
            ...
            <li>
              <Link href="https://www.tiktok.com/@a2zmegastore.kw">
                ...
                >
                  <path
                    d="M15.8086 12.875L16.3008 9.64062H13.1719V7.53125C13.1719 6.61719 13.5938 5.77344 15 5.77344H16.4414V2.99609C16.4414 2.99609 15.1406 2.75 13.9102 2.75C11.3438 2.75 9.65625 4.33203 9.65625 7.14453V9.64062H6.77344V12.875H9.65625V20.75H13.1719V12.875H15.8086Z"
                    fill="#161616"
                  />
                </svg>
              </Link>
            ...
            <li>
              <Link href="https://www.tiktok.com/@a2zmegastore.kw">
                ...
                >
                  <path
                    d="M7.37166 6.05283C6.92165 7.12327 7.0994 9.04115 7.17141 10.3824C6.6854 10.6683 6.06138 10.1665 5.70813 10.1665C5.34062 10.1665 4.90186 10.423 4.83286 10.8053C4.78336 11.0809 4.89961 11.4823 5.73363 11.8319C6.05613 11.9673 6.8234 12.1266 7.00115 12.5711C7.25091 13.1955 5.71863 16.0779 3.31258 16.4984C3.12433 16.5311 2.99008 16.7095 3.00058 16.9118C3.04258 17.6883 4.68211 17.9926 5.40887 18.112C5.48312 18.2188 5.54312 18.6696 5.63838 19.0128C5.68113 19.1665 5.79138 19.3505 6.07488 19.3505C6.44464 19.3505 7.0589 19.0479 8.12842 19.2358C9.17694 19.4214 10.1625 21 12.0548 21C13.8135 21 14.8628 19.4142 15.8723 19.2358C16.4566 19.1331 16.9583 19.1658 17.5194 19.282C17.9056 19.3625 18.2521 19.4071 18.3624 19.0041C18.4591 18.656 18.5184 18.214 18.5911 18.1096C19.3111 17.991 20.9582 17.6875 20.9994 16.911C21.0099 16.7087 20.8757 16.5311 20.6874 16.4976C18.3219 16.0835 16.7431 13.2098 16.9988 12.5703C17.1758 12.1266 17.9379 11.9689 18.2664 11.8312C18.8769 11.5755 19.1829 11.2609 19.1761 10.8969C19.1679 10.431 18.6399 10.153 18.2514 10.153C17.8561 10.153 17.2884 10.65 16.8286 10.3808C16.9006 9.02841 17.0776 7.11929 16.6283 6.04965C15.7771 4.02425 13.8833 3 11.9902 3C10.1092 3 8.22968 4.00991 7.37166 6.05283Z"
                    fill="#161616"
                  />
                </svg>
              </Link>
